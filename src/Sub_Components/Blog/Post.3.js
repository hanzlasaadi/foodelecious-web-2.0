          ...
          <div className="row g-5">
            <div className="col-10">
              <article className="article">
                ...
                <div className="meta-top display-flex py-2">
                  <ul class="d-flex ">
                    <li className="d-flex align-items-center pr-3">
                      <i className="bi bi-person" /> John Doe
                    </li>
                    <li className="d-flex align-items-center pr-3">
                    ...
                    <li className="d-flex align-items-center">
                      <i className="bi bi-chat-dots" /> 12 Comments
                    </li>
                  </ul>
                </div>
